...
function Logo (props){
  ...
  useEffect(() => {
    const blocks = logo.current.children
  ...
  for(let i = 1; i < 5; i++){
    items.push(
      <div className="logo__item" data-glitch={i} key={i}>
        <div data-show="1">
          <svg className="svg-inline--fa fa-kickstarter-k fa-w-12" focusable="false"
          ...
          <svg className="svg-inline--fa fa-kaggle fa-w-10" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 320 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-kickstarter fa-w-14" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 448 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-opera fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 496 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-bullseye fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 496 512">
            <path fill="currentColor"
                  d="M248 8C111.03 8 0 119.03 0 256s111.03 248 248 248 248-111.03 248-248S384.97 8 248 8zm0 432c-101.69 0-184-82.29-184-184 0-101.69 82.29-184 184-184 101.69 0 184 82.29 184 184 0 101.69-82.29 184-184 184zm0-312c-70.69 0-128 57.31-128 128s57.31 128 128 128 128-57.31 128-128-57.31-128-128-128zm0 192c-35.29 0-64-28.71-64-64s28.71-64 64-64 64 28.71 64 64-28.71 64-64 64z"/>
          </svg>
          <svg className="svg-inline--fa fa-circle-notch fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 512 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-tumblr fa-w-10" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 320 512">
            <path fill="currentColor"
                  d="M309.8 480.3c-13.6 14.5-50 31.7-97.4 31.7-120.8 0-147-88.8-147-140.6v-144H17.9c-5.5 0-10-4.5-10-10v-68c0-7.2 4.5-13.6 11.3-16 62-21.8 81.5-76 84.3-117.1.8-11 6.5-16.3 16.1-16.3h70.9c5.5 0 10 4.5 10 10v115.2h83c5.5 0 10 4.4 10 9.9v81.7c0 5.5-4.5 10-10 10h-83.4V360c0 34.2 23.7 53.6 68 35.8 4.8-1.9 9-3.2 12.7-2.2 3.5.9 5.8 3.4 7.4 7.9l22 64.3c1.8 5 3.3 10.6-.4 14.5z"/>
          </svg>
          <svg className="svg-inline--fa fa-tumblr-square fa-w-14" focusable="false"
               xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 448 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-tenge fa-w-12" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 384 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-etsy fa-w-12" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 384 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-edge fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 512 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-ruler-vertical fa-w-8" focusable="false"
               xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 256 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-registered fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 512 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-resolving fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 496 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-rockrms fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 496 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-info fa-w-6" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 192 512">
            <path fill="currentColor"
                  d="M20 424.229h20V279.771H20c-11.046 0-20-8.954-20-20V212c0-11.046 8.954-20 20-20h112c11.046 0 20 8.954 20 20v212.229h20c11.046 0 20 8.954 20 20V492c0 11.046-8.954 20-20 20H20c-11.046 0-20-8.954-20-20v-47.771c0-11.046 8.954-20 20-20zM96 0C56.235 0 24 32.235 24 72s32.235 72 72 72 72-32.235 72-72S135.764 0 96 0z"/>
          </svg>
          <svg className="svg-inline--fa fa-exclamation fa-w-6" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 192 512">
            <path fill="currentColor"
          ...
          <svg className="svg-inline--fa fa-italic fa-w-10" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 320 512">
            <path fill="currentColor"
        ...
        <div data-show="1">
          <svg className="svg-inline--fa fa-neos fa-w-16" focusable="false" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 512 512">
            <path fill="currentColor"
  ...
  return (
    <div className={'logo ' + props.class} ref={logo}>
      {items}
    </div>
  )
}
